...
export interface StableSwapPairInterface extends utils.Interface {
  contractName: "StableSwapPair";
  functions: {
    "A()": FunctionFragment;
...
export type DonateAdminFeesEvent = TypedEvent<[], {}>;
...
export type RevertParametersEvent = TypedEvent<[], {}>;

export type RevertParametersEventFilter =
  TypedEventFilter<RevertParametersEvent>;
...
export type UnkillEvent = TypedEvent<[], {}>;

export type UnkillEventFilter = TypedEventFilter<UnkillEvent>;

export interface StableSwapPair extends BaseContract {
  contractName: "StableSwapPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StableSwapPairInterface;
